...
## Steps the "Bad Actor" took to Create Logs and IoCs (Indicators of Compromises):

1. Download the TOR browser installer: https://www.torproject.org/download/
2. Install it silently in PowerShell: `tor-browser-windows-x86_64-portable-15.0.9.exe /S`
...
4. Connect to TOR and browse a few sites. For example:
   ...
   - Current Dread Dark Markets Forum: `dreadytofatroptsdj6io7l3xptbet6onoyno2yv7jicoxknyazubrad.onion/d/DarkNetMarkets`
